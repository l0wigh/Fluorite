...
void fluorite_close_window()
{
	...
	if ((fluorite.workspaces[fluorite.current_workspace].frames_count == 0 && fluorite.workspaces[fluorite.current_workspace].floating_count == 0) || fluorite.workspaces[fluorite.current_workspace].is_organising)
		return ;
...
{
	XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_inactive);
	for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].slaves_count; i++)
			XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window, fluorite.config.border_inactive);
	...
	if (fluorite.workspaces[fluorite.current_workspace].is_fullscreen)
	{
		XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, 0);
		XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, 0);
	}
	...
	if (fluorite.workspaces[fluorite.current_workspace].frames_count > 0)
	{
		...
		if (!fluorite.workspaces[fluorite.current_workspace].is_fullscreen)
		{
			if (fluorite.workspaces[fluorite.current_workspace].current_focus == MASTER_FOCUS)
			{
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_focused);
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.config.border_unfocused);
			}
			else
			{
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.config.border_focused);
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_unfocused);
			}
		}
	}
	else
...
void fluorite_redraw_organizer()
{
	...
	XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_inactive);
	XMoveResizeWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.workspaces[fluorite.current_workspace].master_winframe->pos_x, fluorite.workspaces[fluorite.current_workspace].master_winframe->pos_y, fluorite.workspaces[fluorite.current_workspace].master_winframe->width, fluorite.workspaces[fluorite.current_workspace].master_winframe->height);
	XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window);
	if (fluorite.workspaces[fluorite.current_workspace].organizer_selected != 0)
	{
		XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[fluorite.workspaces[fluorite.current_workspace].organizer_selected - 1]->window, fluorite.config.border_focused);
		XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[fluorite.workspaces[fluorite.current_workspace].organizer_selected - 1]->window, fluorite.config.border_width);
	}
	else
	{
		XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_focused);
		XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_width);
	}
}
...
void fluorite_organizer_mapping(int mode)
{
	...
	switch (mode)
	{
		case SELECT_NEXT:
			...
			if (fluorite.workspaces[fluorite.current_workspace].organizer_selected == fluorite.workspaces[fluorite.current_workspace].frames_count)
	...
	switch(mode)
	{
		...
		case FULLSCREEN_TOGGLE:
			...
			if (fluorite.workspaces[fluorite.current_workspace].is_fullscreen == 0)
			{
				...
				if (fluorite.workspaces[fluorite.current_workspace].current_focus == MASTER_FOCUS)
				{
					XReparentWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, tmp_window, RevertToPointerRoot, CurrentTime);
				...
				{
					XReparentWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, tmp_window, RevertToPointerRoot, CurrentTime);
			...
			else
			{
				...
				if (fluorite.workspaces[fluorite.current_workspace].current_focus == MASTER_FOCUS)
				{
					XReparentWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.root, RevertToPointerRoot, CurrentTime);
				...
				{
					XReparentWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.root, RevertToPointerRoot, CurrentTime);
					XUnmapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->fullscreen_frame);
					XSetInputFocus(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, RevertToPointerRoot, CurrentTime);
					XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.config.border_width);
					XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.config.border_focused);
				}
				XSync(fluorite.display, True);
				fluorite_redraw_windows();
		...
		case ORGANIZER_TOGGLE:
			if (fluorite.workspaces[fluorite.current_workspace].frames_count <= 1 || fluorite.workspaces[fluorite.current_workspace].is_organising)
			{
		...
		case SWAP_FOCUS:
			...
			else
			{
				...
				if (w == fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window && fluorite.workspaces[fluorite.current_workspace].layout == RIVER_TOGGLE && fluorite.workspaces[fluorite.current_workspace].slaves_count > 1)
				{
					...
					for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].floating_count; i++)
						XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].floating_windows[i]->window, fluorite.config.border_unfocused);
					XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[1]->window, fluorite.config.border_focused);
					XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, fluorite.config.border_unfocused);
					XSetInputFocus(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[1]->window, RevertToPointerRoot, CurrentTime);
					XChangeProperty(fluorite.display, fluorite.root, XInternAtom(fluorite.display, "_NET_ACTIVE_WINDOW", False), XA_WINDOW, 32, PropModeReplace, (const unsigned char *) &fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, 1);
				}
				else
				{
		...
		case FLOATING_TOGGLE:
			{
				Window focused;
				int revert;
				int keep_x, keep_y, keep_w, keep_h;

				XGetInputFocus(fluorite.display, &focused, &revert);
				for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].slaves_count; i++)
				{
                  if (focused == fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window && fluorite.workspaces[fluorite.current_workspace].floating_count < MAX_WINDOWS && fluorite.workspaces[fluorite.current_workspace].slaves_count != 0)
					{
						keep_x = fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_x;
						keep_y = fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_y;
						keep_w = fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->width;
						keep_h = fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->height;
						fluorite.workspaces[fluorite.current_workspace].frames_count--;
						bzero(fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i], sizeof(WinFrames));
						fluorite_handle_specials(focused);
						fluorite_organise_stack(STACK_DEL, i);
						fluorite.workspaces[fluorite.current_workspace].slaves_count--;
						XMoveWindow(fluorite.display, focused, keep_x, keep_y);
						XResizeWindow(fluorite.display, focused, keep_w, keep_h);
						fluorite_redraw_windows();
						return ;
					}
				}
				...
				{
					keep_x = fluorite.workspaces[fluorite.current_workspace].master_winframe->pos_x;
					keep_y = fluorite.workspaces[fluorite.current_workspace].master_winframe->pos_y;
					keep_w = fluorite.workspaces[fluorite.current_workspace].master_winframe->width;
					keep_h = fluorite.workspaces[fluorite.current_workspace].master_winframe->height;
					fluorite.workspaces[fluorite.current_workspace].frames_count--;
		...
		case FLOATING_HIDE_SHOW:
			...
			if (!fluorite.workspaces[fluorite.current_workspace].floating_hidden)
				for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].floating_count; i++)
					XUnmapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].floating_windows[i]->window);
			else
				for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].floating_count; i++)
					XMapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].floating_windows[i]->window);
...
void fluorite_show_new_workspace(int new_workspace)
{
	for (int i = 0; i < fluorite.monitor_count; i++)
	{
		if (fluorite.monitor[i].workspace == new_workspace)
		{
			...
			{
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.monitor[j].workspace].master_winframe->window, fluorite.config.border_unfocused);
				XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.monitor[j].workspace].slaves_winframes[0]->window, fluorite.config.border_unfocused);
				XSetInputFocus(fluorite.display, fluorite.root, RevertToPointerRoot, CurrentTime);
			}
			if (fluorite.workspaces[fluorite.current_workspace].is_fullscreen)
			{
	...
	if (fluorite.workspaces[fluorite.current_workspace].frames_count > 0)
	{
		if (fluorite.workspaces[fluorite.current_workspace].master_winframe->window)
			XUnmapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window);
		for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].slaves_count; i++)
			XUnmapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window);
		if (fluorite.workspaces[fluorite.current_workspace].is_fullscreen)
		{
			fluorite_change_layout(FULLSCREEN_TOGGLE);
			fluorite.workspaces[fluorite.current_workspace].is_fullscreen = 1;
	...
	if (fluorite.workspaces[fluorite.current_workspace].frames_count > 0)
	{
		...
		for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].slaves_count; i++)
			XMapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window);
		if (fluorite.workspaces[fluorite.current_workspace].is_fullscreen)
		{
			fluorite.workspaces[fluorite.current_workspace].is_fullscreen = 0;
			fluorite_change_layout(FULLSCREEN_TOGGLE);
...
void fluorite_send_window(int new_workspace)
{
	...
	if (fluorite.workspaces[fluorite.current_workspace].current_focus == SLAVE_FOCUS)
	{
		for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].slaves_count; i++)
		{
			if (fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window == w)
			{
				memcpy(fluorite.workspaces[fluorite.current_workspace].tmp_winframe, fluorite.workspaces[fluorite.current_workspace].master_winframe, sizeof(WinFrames));
				memcpy(fluorite.workspaces[fluorite.current_workspace].master_winframe, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i], sizeof(WinFrames));
				fluorite_organise_stack(STACK_DEL, i);
				fluorite.workspaces[fluorite.current_workspace].slaves_count--;
				is_slave = 1;
			}
	...
	XUnmapWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window);
	XSetInputFocus(fluorite.display, fluorite.root, RevertToPointerRoot, CurrentTime);
	if (fluorite.workspaces[fluorite.current_workspace].slaves_count > 0 && !is_slave)
	{
		memcpy(fluorite.workspaces[fluorite.current_workspace].master_winframe, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0], sizeof(WinFrames));
		XSetInputFocus(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, RevertToPointerRoot, CurrentTime);
		XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window);
	...
	if (is_slave)
	{
		...
		XSetInputFocus(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window, RevertToPointerRoot, CurrentTime);
		XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].master_winframe->window);
		fluorite_organise_stack(STACK_UP, 0);
	}
...
void fluorite_get_monitor_from_mouse()
{
...
void fluorite_run()
{
	...
	while (fluorite.running)
	{
		...
		fluorite_get_monitor_from_mouse();
		switch (ev.type)
		{
...
void fluorite_clean()
{
	...
	for (int i = 0; i < MAX_WORKSPACES; i++)
	{
		...
		for (int i = 0; fluorite.workspaces[fluorite.current_workspace].floating_windows[i]; i++)
			free(fluorite.workspaces[fluorite.current_workspace].floating_windows[i]);
		free(fluorite.workspaces[fluorite.current_workspace].floating_windows);
	}
...
void fluorite_handle_specials(Window e)
{
	...
	unsigned int xdo_width, xdo_height; int xdo_x, xdo_y;
	...
	xdo_get_window_size(fluorite.xdo, e, &xdo_width, &xdo_height);
	xdo_get_window_location(fluorite.xdo, e, &xdo_x, &xdo_y, NULL);
	fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->width = xdo_width;
	fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->height = xdo_height;
	if (xdo_x - fluorite.monitor[fluorite.current_monitor].pos_x > 1)
		fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->pos_x = xdo_x;
	else
		fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->pos_x = fluorite.monitor[fluorite.current_monitor].pos_x + (fluorite.monitor[fluorite.current_monitor].width  - fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->width) / 2;
	if (xdo_y - fluorite.monitor[fluorite.current_monitor].pos_y > 1)
		fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->pos_y = xdo_y;
	else
		fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->pos_y = fluorite.monitor[fluorite.current_monitor].pos_y + (fluorite.monitor[fluorite.current_monitor].height - fluorite.workspaces[fluorite.current_workspace].floating_windows[pos]->height) / 2;
	XMapWindow(fluorite.display, e);
	XGrabButton(fluorite.display, Button1, METAKEY, e, False, ButtonPressMask | ButtonReleaseMask | ButtonMotionMask, GrabModeAsync, GrabModeAsync, None, None);
	XGrabButton(fluorite.display, Button3, METAKEY, e, False, ButtonPressMask | ButtonReleaseMask | ButtonMotionMask, GrabModeAsync, GrabModeAsync, None, None);
	XSetWindowBorderWidth(fluorite.display, e, fluorite.config.border_width);
...
pid_t fluorite_get_parent(pid_t new_pid)
{
	unsigned int v = 0;
	FILE *f;
	char buf[256];

	snprintf(buf, sizeof(buf) - 1, "/proc/%u/stat", (unsigned)new_pid);
...
int fluorite_check_parent(pid_t frame_pid, pid_t new_pid)
{
	while (frame_pid != new_pid && new_pid != 0)
		new_pid = fluorite_get_parent(new_pid);
	return (int)new_pid;
}
...
void fluorite_handle_normals(Window e)
{
	...
	XSelectInput(fluorite.display, e, SubstructureNotifyMask | SubstructureRedirectMask | EnterWindowMask);
	XGrabButton(fluorite.display, Button1, METAKEY, e, False, ButtonPressMask | ButtonReleaseMask | ButtonMotionMask, GrabModeAsync, GrabModeAsync, None, None);
	XGrabButton(fluorite.display, Button3, METAKEY, e, False, ButtonPressMask | ButtonReleaseMask | ButtonMotionMask, GrabModeAsync, GrabModeAsync, None, None);
	XSetWindowBorder(fluorite.display, e, fluorite.config.border_focused);
	XSetWindowBorderWidth(fluorite.display, e, fluorite.config.border_width);
	XMapWindow(fluorite.display, e);
	XRaiseWindow(fluorite.display, e);
	XSync(fluorite.display, True);
...
void fluorite_handle_enternotify(XEvent e)
{
	...
	for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].floating_count; i++)
		XSetWindowBorder(fluorite.display, fluorite.workspaces[fluorite.current_workspace].floating_windows[i]->window, fluorite.config.border_unfocused);
	XSetInputFocus(fluorite.display, e.xcrossing.window, RevertToPointerRoot, CurrentTime);
	XSetWindowBorder(fluorite.display, e.xcrossing.window, fluorite.config.border_focused);
	XChangeProperty(fluorite.display, fluorite.root, XInternAtom(fluorite.display, "_NET_ACTIVE_WINDOW", False), XA_WINDOW, 32, PropModeReplace, (const unsigned char *) &e.xcrossing.window, 1);

	if (e.xcrossing.window == fluorite.workspaces[fluorite.current_workspace].master_winframe->window)
		fluorite.workspaces[fluorite.current_workspace].current_focus = MASTER_FOCUS;
	else
		fluorite.workspaces[fluorite.current_workspace].current_focus = SLAVE_FOCUS;
}
...
void fluorite_handle_motions(XMotionEvent e)
{
	...
	XSizeHints hints;
	int pos_x, pos_y, max_x, max_y;
	int window_pos_x, window_pos_y, window_max_x, window_max_y;
		...
		for (int i = 0; i < fluorite.workspaces[fluorite.current_workspace].floating_count; i++)
		{
			if (e.window == fluorite.workspaces[fluorite.current_workspace].floating_windows[i]->window)
			{
				...
				if (e.state & Button1Mask)
				{
					...
					if (window_pos_x + drag_dest_x < pos_x - fluorite.config.border_width)
						drag_dest_x = pos_x + (fluorite.config.border_width * 2);
					if (window_max_x + drag_dest_x > max_x)
						drag_dest_x = max_x - window_max_x;
					if (drag_dest_y < pos_y - fluorite.config.border_width)
						drag_dest_y = pos_y + (fluorite.config.border_width * 2);
...
void fluorite_redraw_tiling()
{
	if (fluorite.workspaces[fluorite.current_workspace].slaves_count > 0)
	{
		...
		for (int i = fluorite.workspaces[fluorite.current_workspace].slaves_count - 1; i >= 0; i--)
		{
			...
			XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window, fluorite.config.border_width);
			XMoveResizeWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_x, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_y, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->width, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->height);
			XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window);
...
void fluorite_redraw_river()
{
	if (fluorite.workspaces[fluorite.current_workspace].slaves_count > 0)
	{
		...
		position_offset = 0;
		size_offset = fluorite.config.stack_offset * (fluorite.workspaces[fluorite.current_workspace].slaves_count - 2) * 10;
		for (int i = fluorite.workspaces[fluorite.current_workspace].slaves_count - 1; i >= 1; i--)
		{
			fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_x = fluorite.monitor[fluorite.current_monitor].pos_x + fluorite.monitor[fluorite.current_monitor].width / 2 + (fluorite.config.gaps) + (position_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count) + fluorite.workspaces[fluorite.current_workspace].master_offset;
			if (fluorite.monitor[fluorite.current_monitor].primary == True || PRIMARY_BAR_ONLY == False)
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_y = fluorite.monitor[fluorite.current_monitor].pos_y + (fluorite.config.gaps * 2) + (position_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count) + fluorite.config.topbar_gaps + (fluorite.monitor[fluorite.current_monitor].height / 2) - fluorite.config.bottombar_gaps;
			else
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_y = fluorite.monitor[fluorite.current_monitor].pos_y + (fluorite.config.gaps * 2) + (position_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count) + (fluorite.monitor[fluorite.current_monitor].height / 2);
			fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->width =  fluorite.monitor[fluorite.current_monitor].width / 2 - (fluorite.config.border_width * 2) - (fluorite.config.gaps * 3) - (size_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count) - fluorite.workspaces[fluorite.current_workspace].master_offset;
			if (fluorite.monitor[fluorite.current_monitor].primary == True || PRIMARY_BAR_ONLY == False)
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->height = (fluorite.monitor[fluorite.current_monitor].height / 2) - (fluorite.config.border_width * 2) - (fluorite.config.gaps * 4) - (size_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count) - fluorite.config.topbar_gaps;
			else
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->height = (fluorite.monitor[fluorite.current_monitor].height / 2) - (fluorite.config.border_width * 2) - (fluorite.config.gaps * 4) - (size_offset / fluorite.workspaces[fluorite.current_workspace].slaves_count);
			XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window, fluorite.config.border_width);
			XMoveResizeWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_x, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->pos_y, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->width, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->height);
			XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[i]->window);
			position_offset += fluorite.config.stack_offset * 10;
		...
		fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->pos_x = fluorite.monitor[fluorite.current_monitor].pos_x + fluorite.monitor[fluorite.current_monitor].width / 2 + (fluorite.config.gaps) + fluorite.workspaces[fluorite.current_workspace].master_offset;
		fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->width =  fluorite.monitor[fluorite.current_monitor].width / 2 - (fluorite.config.border_width * 2) - (fluorite.config.gaps * 3) - fluorite.workspaces[fluorite.current_workspace].master_offset;
		if (fluorite.monitor[fluorite.current_monitor].primary == True || PRIMARY_BAR_ONLY == False)
			fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->pos_y = fluorite.monitor[fluorite.current_monitor].pos_y + (fluorite.config.gaps * 2) + fluorite.config.topbar_gaps;
		else
			fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->pos_y = fluorite.monitor[fluorite.current_monitor].pos_y + (fluorite.config.gaps * 2);
		if (fluorite.workspaces[fluorite.current_workspace].slaves_count > 1)
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->height = (fluorite.monitor[fluorite.current_monitor].height / 2) - (fluorite.config.border_width * 2) - (fluorite.config.gaps * 2) - fluorite.config.bottombar_gaps;
		else
		{
			if (fluorite.monitor[fluorite.current_monitor].primary == True || PRIMARY_BAR_ONLY == False)
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->height = fluorite.monitor[fluorite.current_monitor].height - (fluorite.config.border_width * 4) - (fluorite.config.gaps * 4) - fluorite.config.topbar_gaps - fluorite.config.bottombar_gaps;
			else
				fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->height = fluorite.monitor[fluorite.current_monitor].height - (fluorite.config.border_width * 4) - (fluorite.config.gaps * 4);
		}
		XSetWindowBorderWidth(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.config.border_width);
		XMoveResizeWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->pos_x, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->pos_y, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->width, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->height);
		XRaiseWindow(fluorite.display, fluorite.workspaces[fluorite.current_workspace].slaves_winframes[0]->window);
	}
}
...
void fluorite_handle_unmapping(Window e)
{
	...
	for (int i = 0; i < MAX_WORKSPACES; i++)
	{
		...
		for (int j = 0; j < fluorite.workspaces[fluorite.current_workspace].floating_count; j++)
			...
			{
				for (int h = j + 1; h < fluorite.workspaces[fluorite.current_workspace].floating_count; h++)
					memcpy(fluorite.workspaces[fluorite.current_workspace].floating_windows[h - 1], fluorite.workspaces[fluorite.current_workspace].floating_windows[h], sizeof(Floating));
				fluorite.workspaces[fluorite.current_workspace].floating_count--;
				XSetInputFocus(fluorite.display, fluorite.root, RevertToPointerRoot, CurrentTime);
				XDeleteProperty(fluorite.display, fluorite.root, XInternAtom(fluorite.display, "_NET_ACTIVE_WINDOW", False));
				fluorite.current_workspace = keep_workspace;
